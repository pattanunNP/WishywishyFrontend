  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center focus:outline-none ">
        <div className="z-40 absolute bg-white xs:w-[320px] xs:h-[300px] md:h-[360px] md:w-[420px]  rounded-xl shadow-lg shadow-gray-800 transition ease-in-out delay-350 opacity-100">
